...
import (
	...
	versioned "github.com/packyzbq/Demo/CRDsDemo/pkg/apis/example.com/v1/clientset/versioned"
	internalinterfaces "github.com/packyzbq/Demo/CRDsDemo/pkg/apis/example.com/v1/informers/externalversions/internalinterfaces"
	v1 "github.com/packyzbq/Demo/CRDsDemo/pkg/apis/example.com/v1/listers/example.com/v1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.ExampleV1().Demos(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ExampleV1().Demos(namespace).Watch(context.TODO(), options)
			},
		},
		&examplecomv1.Demo{},
		resyncPeriod,
...
func (f *demoInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&examplecomv1.Demo{}, f.defaultInformer)
}
