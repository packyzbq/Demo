...
import (
	...
	v1 "github.com/packyzbq/Demo/CRDsDemo/pkg/apis/example.com/v1"
	scheme "github.com/packyzbq/Demo/CRDsDemo/pkg/apis/example.com/v1/clientset/versioned/scheme"
...
func newDemos(c *ExampleV1Client, namespace string) *demos {
	return &demos{
		client: c.RESTClient(),
		ns:     namespace,
	}
